...
void mainscr()
{
  ...
  textcolor(LIGHTMAGENTA);
   ...
   gotoxy(8,3);
   cprintf("ÌÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¹  Welcome To Obaid Books ÌÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ?);
   gotoxy(8,4);
   cprintf("?                   ÈÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ?                ?);
   gotoxy(8,5);
   cprintf("ÈÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¼");
   textcolor(RED);
   gotoxy(1,10);
...
void allmem()
{
 ...
 printf("\nºId?      Name       ?       Address           ºMember SinceºExpiration    ?);
 printf("\nÌÍÍÎÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÎÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÎÍÍÍÍÍÍÍÍÍÍÍÍÎÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¹");
 while(fread(&M,sizeof(M),1,fm)==1)
 {
   printf("\n?-2d?-18s?-26s?%-2d/%-2d/%-4d ? %-2d/%-2d/%-4d  ?,M.mid,M.mname,M.madd,M.ms.day,M.ms.mon,M.ms.year,M.me.day,M.me.mon,M.me.year);
 }
 printf("\nÈÍÍÊÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¼");
   getch();
}
...
void allbook()
{
  ...
  printf("\nÌÍÍÍÍÍÍÍÍÎÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÎÍÍÍÍÍÍÍÍÍÍÍÍÍÍÎÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÎÍÍÍÍÍÍÍ?);
 while(fread(&B,sizeof(B),1,fb)==1)
 {
  printf("\n?d%d%d  ?,B.b.bno,B.b.gno,B.b.no);
  printf("%-19s?-14s?-19s?d    ?,B.bname,B.author,B.pub,B.price);
  }
  printf("\nÈÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍ?);
     getch();
}
...
void alltransac()
{
   ...
   printf("\nÌÍÍÍÍÍÍÍÍÍÍÎÍÍÍÍÍÍÍÍÎÍÍÍÍÍÍÍÍÍÍÍÎÍÍÍÍÍÍÍÍÍÍÍÍÎÍÍÍÍÍÍÍÍÍÍÍÍÍÎÍÍÍÍÍÍÍÍÎÍÍÍÍÍÍÍÍ¹");
 while(fread(&T,sizeof(T),1,ft)==1)
  {
   ...
   printf("\nÈÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÍ¼");
   gotoxy(1,25);
   textcolor(WHITE);
   cprintf("A");
   textcolor(DARKGRAY);
